            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
              <div class="page-header">
                ...
                <div class="page-breadcrumb">
                  ...
                  <a href="./index.html" class="btn btn-rounded btn-primary">Back</a>
                </div>
              </div>
            </div>
          </div>
                    ...
                    <div class="card-body">
                        <form method="post" action="${pageContext.request.contextPath}/admin/${action}-category" id="basicform" data-parsley-validate="" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <input id="name" type="text" name="name" value="${store.name}" data-parsley-trigger="change" required="" placeholder="Tên" autocomplete="off" class="form-control">
                            </div>
                            <div class="form-group">
                                <label for="bio">Mô tả</label>
                                <input id="bio" type="text" name="bio" value="${store.bio}" data-parsley-trigger="change" required="" placeholder="Mô tả" autocomplete="off" class="form-control">
                            </div>
                            <div class="form-group">
                                <label for="ownerId">ID chủ sở hữu</label>
                                <input id="ownerId" type="text" name="ownerId" value="${store.ownerId}" data-parsley-trigger="change" required="" placeholder="ID chủ sở hữu" autocomplete="off" class="form-control">
                            </div>
                            <div class="form-group">
                                <label for="avatar">Avatar</label>
                                <input id="avatar" type="text" name="avatar" value="${store.avatar}" data-parsley-trigger="change" required="" placeholder="Đường dẫn Avatar" autocomplete="off" class="form-control">
                            </div>
                            <div class="row">
                                <div class="col-sm-6 pl-0">
                                    <p class="text-left">
                                        <button type="submit" class="btn btn-space btn-primary">Đổi</button>
                                    </p>
                                </div>
                            </div>
                        </form>
