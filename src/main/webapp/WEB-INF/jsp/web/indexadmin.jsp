...
<html>
  <head>
    ...
    <link
      rel="stylesheet"
      href="admin/assets/vendor/charts/chartist-bundle/chartist.css"
    />
    <link
      rel="stylesheet"
      href="admin/assets/vendor/charts/morris-bundle/morris.css"
    />
    <link
      rel="stylesheet"
      href="admin/assets/vendor/fonts/material-design-iconic-font/css/materialdesignicons.min.css"
    />
    <link rel="stylesheet" href="admin/assets/vendor/charts/c3charts/c3.css" />
    <link
      rel="stylesheet"
      href="admin/assets/vendor/fonts/flag-icon-css/flag-icon.min.css"
    />
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td>
                                <div class="m-r-10">
                                  <img
                                    src="admin/assets/images/product-pic.jpg"
                                    alt="user"
                                    class="rounded"
                                    width="45"
                                  />
                            ...
                            <tr>
                              ...
                              <td>
                                <div class="m-r-10">
                                  <img
                                    src="admin/assets/images/product-pic-2.jpg"
                                    alt="user"
                                    class="rounded"
                                    width="45"
                                  />
                            ...
                            <tr>
                              ...
                              <td>
                                <div class="m-r-10">
                                  <img
                                    src="admin/assets/images/product-pic-3.jpg"
                                    alt="user"
                                    class="rounded"
                                    width="45"
                                  />
                            ...
                            <tr>
                              ...
                              <td>
                                <div class="m-r-10">
                                  <img
                                    src="admin/assets/images/product-pic-4.jpg"
                                    alt="user"
                                    class="rounded"
                                    width="45"
                                  />
