        ...
        <div class="container-fluid dashboard-content">
                ...
                <div class="page-breadcrumb">
                  <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                      ...
                      <li class="breadcrumb-item">
                        <a href="./store.html" class="breadcrumb-link"
                          >Quản lý cửa hàng</a
                        >
                      </li>
                  ...
                  <a href="./store.html" class="btn btn-rounded btn-primary">Back</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                <div class="card">
                    <h5 class="card-header">Chi tiết cửa hàng</h5>
                    <div class="card-body">
                        <form method="post" action="${pageContext.request.contextPath}/admin/${action}-category" id="basicform" data-parsley-validate="" enctype="multipart/form-data">
                            <div class="form-group">
                                <label for="IDStore">ID cửa hàng</label>
                                <input id="IDStore" readonly type="number" name="IDStore" value="${store.id}" data-parsley-trigger="change" placeholder="ID cửa hàng" autocomplete="off" class="form-control">
                            </div>
                            <div class="form-group">
                                <label for="inputName">Tên cửa hàng</label>
                                <input id="inputName" type="text" name="name" value="${store.name}" data-parsley-trigger="change" required="" placeholder="Tên cửa hàng" autocomplete="off" class="form-control">
                            </div>
                            <div class="form-group">
                                <label for="IDOwner">ID chủ sở hữu</label>
                                <input id="IDOwner" type="number" name="IDOwner" value="&{store.ownerId}" data-parsley-trigger="change" placeholder="ID chủ sở hữu" autocomplete="off" class="form-control">
                            </div>
                            <div class="row">
