          ...
          <div class="row">
            ...
            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" action="${pageContext.request.contextPath}/admin/${action}-product" id="basicform" data-parsley-validate="" enctype="multipart/form-data">
                            <div class="form-group">
                                <label for="ID">ID</label>
                                <input id="ID" readonly type="text" name="price" value="${product.id}" data-parsley-trigger="change" placeholder="ID" autocomplete="off" class="form-control">
                            </div>
                            <div class="form-group">
                                <label for="inputName">Tên sản phẩm</label>
                                <input id="inputName" type="text" name="name" data-parsley-trigger="change" required="" placeholder="Tên sản phẩm" autocomplete="off" class="form-control">
                            </div>
                            <div class="form-group">
                                <label for="inputPrice">Giá</label>
                                <input id="inputPrice" type="number" name="price" value="${product.price}" data-parsley-trigger="change" required="" placeholder="Giá" autocomplete="off" class="form-control">
                            </div>
                            <div class="form-group">
                                <label for="inputPromotionalPrice">Giá khuyến mãi</label>
                                <input id="inputPromotionalPrice" type="number" value="${product.promotionalPrice}" placeholder="Giá khuyến mãi" required="" class="form-control">
                            </div>
                            <div class="form-group">
                                <label for="inputIDStore">Mã cửa hàng</label>
                                <input id="inputIDStore" type="text" required="" placeholder="Mã cửa hàng" class="form-control">
                            </div>
                            <div class="row">
