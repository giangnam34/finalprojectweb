                ...
                <div class="page-breadcrumb">
                  <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                      ...
                      <li class="breadcrumb-item">
                        <a href="./category.html" class="breadcrumb-link"
                          >Quản lý danh mục</a
                        >
                      </li>
                  ...
                  <a href="./category.html" class="btn btn-rounded btn-primary">Back</a>
                </div>
              </div>
            </div>
          </div>
                    ...
                    <div class="card-body">
                        <form method="post" action="${pageContext.request.contextPath}/admin/${action}-category" id="basicform" data-parsley-validate="" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <input id="ID" readonly type="text" name="price" value="${category.id}" data-parsley-trigger="change" placeholder="ID" autocomplete="off" class="form-control">
                            </div>
                            <div class="form-group">
                                <label for="inputName">Tên danh mục</label>
                                <input id="inputName" type="text" name="name" data-parsley-trigger="change" required="" placeholder="Tên danh mục" autocomplete="off" class="form-control">
                            </div>
                            <div class="row">
